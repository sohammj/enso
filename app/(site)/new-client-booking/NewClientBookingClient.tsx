    ...
    <main className="min-h-screen bg-[url('/paper-texture.jpg')] bg-repeat text-[#0E1E2A] px-4 py-10 relative overflow-visible">
      ...
      <div className="mx-auto max-w-4xl relative z-[10]">
        ...
        <section className="mt-8">
          {/* ✅ MOBILE: horizontal socials ABOVE intake form */}
        ...
        <section className="mt-10">
          ...
          <p className="mt-1 text-sm opacity-80">Choose an available slot in the calendar.</p>
    ...
    >
      {socials.map((s) => (
        <a
          ...
          title={s.label}
        >
          <Image src={s.icon} alt="" width={22} height={22} className="opacity-80 transition group-hover:opacity-100" />
        </a>
      ))}
    </div>
  );
