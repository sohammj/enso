...
//         { r: 0.31, g: 0.43, b: 0.63 }, // #506EA1  Serene Indigo (logo blue)
//         { r: 0.78, g: 0.65, b: 0.54 }, // #C8A78A  Clay Taupe (warm neutral)
//         { r: 0.96, g: 0.93, b: 0.91 }  // #F5EEE7  Linen Mist (soft beige)
//       ];

//       // Pick one color at random for each stroke
//       const c = palette[Math.floor(Math.random() * palette.length)];

//       // Slightly soften brightness for natural brush flow
//       return { r: c.r * 0.9, g: c.g * 0.9, b: c.b * 0.9 };
//     }
...
//       <canvas ref={canvasRef} id="fluid" className="w-full h-screen block"></canvas>
//     </div>
//   );
// }
